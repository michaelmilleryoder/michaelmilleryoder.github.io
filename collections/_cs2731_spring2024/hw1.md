...
**Due 2024-02-01, 11:59pm**. *Instructions last updated 2024-01-10.*
...
Write this code from scratch, i.e. do not compute these matrices using any packages (like scikit-learn).
...
* Provide the top 10 associated words (the output from `rank_words`) with `juliet` and at least 2 other target words of your choice for both term-document and term-context vector spaces.
* Which vector space (term-document or term-context) produce similar words that make more sense than others and why do you think that is the case? Back up your conclusions by referring to the top associated term lists you provided.
...
Write this code from scratch, i.e. do not compute these matrices using any packages.
...
* Provide the top 10 associated words (the output from `rank_words`) with `juliet` and at least 2 other target words of your choice for tf-idf-weighted term-document matrices and PPMI-weighted term-context matrices.
